 ...
 * These are registered programmatically and compiled into the CLI.
 */

import { registerBundledSkill as registerSkill, getBundledSkillDefinitions } from "./loader.js";
import type { BundledSkillDefinition, ToolUseContext, HooksSettings, ContentBlockParam } from "./types.js";
...
export function createSimpleBundledSkill(params: {
  ...
  return {
    ...
    getPromptForCommand: async (_args: string, _ctx: ToolUseContext): Promise<ContentBlockParam[]> => {
...
export function createBundledSkillWithArgs(params: {
  ...
  return {
    ...
    aliases: params.aliases,
    userInvocable: params.userInvocable ?? true,
    getPromptForCommand: async (args: string, _ctx: ToolUseContext): Promise<ContentBlockParam[]> => {
...
export function registerCommonBundledSkills(): void {
  ...
  registerBundledSkill(
    createBundledSkillWithArgs({
      ...
      whenToUse: "Use this when asked to review code changes, pull requests, or specific files.",
      argumentHint: "<files>",
...
After fixing, run existing tests to ensure nothing is broken.`,
  ...
  registerBundledSkill(
    createBundledSkillWithArgs({
      ...
      whenToUse: "Use this when asked to refactor or improve code structure.",
      argumentHint: "<files>",
...
Follow the existing code style and patterns.`,
  ...
  registerBundledSkill(
    createBundledSkillWithArgs({
      ...
      whenToUse: "Use this when asked to review security or when handling sensitive data.",
      argumentHint: "<files>",
...
Generate a commit message for the current changes.`,
  ...
  registerBundledSkill(
    createBundledSkillWithArgs({
      ...
      whenToUse: "Use this when migrating code between frameworks or versions.",
...
Proceed with the migration.`,
  ...
  registerBundledSkill(
    createBundledSkillWithArgs({
      ...
      whenToUse: "Use this when investigating bugs or unexpected behavior.",
